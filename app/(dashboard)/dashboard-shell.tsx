      ...
      <aside className="hidden lg:flex w-60 shrink-0 flex-col border-r border-border bg-card">
        ...
        <div className="h-16 flex items-center gap-3 px-5 border-b border-border">
          <div className="w-9 h-9 rounded-xl brand-gradient flex items-center justify-center shrink-0 shadow-sm">
            <span className="text-base font-black text-white tracking-tight">H</span>
          </div>
          <div className="leading-none">
            <p className="text-base font-black text-foreground tracking-tight">
              Ha<span className="text-primary">Ty</span>
            </p>
            <p className="text-[11px] text-muted-foreground mt-0.5">หาที่ง่าย จัดการได้</p>
          </div>
        </div>
        ...
        <div className="px-3 py-4 border-t border-border space-y-2">
          {plan === 'LITE' ? (
            <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-amber-50 border border-amber-200">
              <span className="text-xs font-bold text-amber-700 flex-1">HaTy Lite</span>
              <span className="text-[10px] text-amber-600">1 ตึก · 5 ห้อง</span>
            </div>
          ) : (
            <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-primary/8 border border-primary/20">
              <Zap className="w-3.5 h-3.5 text-primary shrink-0" />
              <span className="text-xs font-bold text-primary">HaTy Pro</span>
            </div>
          )}

    ...
    <div className="space-y-6 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
        {tenants.map((tenant: any) => (
          <div key={tenant.id} className="surface rounded-xl p-5 space-y-4 group hover:border-primary/40 transition-colors">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[10px] text-muted-foreground font-mono uppercase mt-0.5">#{tenant.id.slice(-6)}</p>
              </div>
              {tenant.lineUserId && (
                <Badge className="text-[10px] bg-emerald-50 text-emerald-700 border-emerald-200 gap-1 shrink-0">
